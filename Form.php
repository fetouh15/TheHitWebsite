...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Prompt&display=swap" rel="stylesheet">    <link href="styles/form.css" rel="stylesheet">
...
<!--<script src="Navbar.js" ></script>-->
  ...
  <nav class="navbar navbar-expand-lg    navbar-dark  sticky-top"style="background-color: #000000;  ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" >
            <ul class="navbar-nav mr-auto" style="font-size:2.1vw;font-family: 'Prompt', sans-serif; margin-left:2vw;">
                <li class="nav-item " >
...
<div class="jumbotron jumbotron-fluid"  style="background-color: black; background-image: url('img/MailingListBack.jpg');background-repeat: no-repeat; background-size: cover; padding-top: 20px; " id="form">
 ...
 <div class="col-lg-7 col-md-12 col-sm-12" ><!-- <img id="form2" src="background2.jpg">--> <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br></div>
      ...
      <h1 style="color:#8F1924; font-family: 'Kanit', sans-serif;" id="form-title"><strong >Subscribe Now</strong> <br/> Get your first session for free!</h1>
      </div>
      <div class=:"col-sm-10 col-xs-">
          </div>
  <div class="form-group">
      <label class="control-label " for="email" style="color:#FFFFFF"><h3>Full Name:</h3></label>
      
          <input type="text" class="form-control col-sm-10 " id="name" name="name" required>
  
  </div>
   <div class="form-group">
       <label class="control-label " for="email" style="color: white"><h3>Email:</h3></label>
    
      <input type="email" class="form-control col-sm-10" id="email" name="email" required >
 
  </div>
  <div class="form-group">
      <label class="control-label " for="pwd" style="color : white" ><h3>Phone number:</h3></label>
  ...
  <div class="form-group col-lg-12">  <button name="submit" type="submit" id="submit" class="btn col-4 " style="background-color: #8F1924; color:white;  " ><h4>Submit</h4></button> </div>
