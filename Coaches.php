...
<div class="card-body">
   <strong class="card-title" style="vertical-align:top; font-size:35px; font-family: 'Prompt', sans-serif;"> <?php echo $row['Name']; ?> <i style="color:#8F1924;font-family: 'Prompt', sans-serif;"> </i></strong> <p class="card-text" style="color:#f2f2f2; font-family: 'Prompt', sans-serif;  font-weight: 700;"><br><?php echo $row['Description'] ?></p>
