...
<meta name="viewport" content="width=device-width">
    ...
    <link href="styles/Classes.css" rel="stylesheet">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row=  $result->fetch_assoc())
            {
                ...
                <div class="col-lg-4 col-sm-6 col-xs-12">
                    <div class="card h-100" style=" margin-left:20px; margin-right:20px; margin-top:20px;  " id="class-card">
                        <img class="card-img-top" src=<?php echo $row['Picture'] ?> alt="Card image cap" style="object-fit: cover;  width: 100%; height:300px;">
                        <div class="card-body">
                          <strong class="card-title" style="vertical-align:top; font-size:35px; font-family: 'Prompt', sans-serif; "> <?php echo $row['Name']; ?> </strong> 

                          <p class="card-text" style="color:#f2f2f2;   font-weight: 700; font-family: 'Prompt', sans-serif;"><br>
                          <?php echo $row['Description']; ?></p>
                          <?php  if($row['Ladies_Only']=="1") {  echo '<footer class="blockquote-footer"> <regular style="vertical-align:middle; color:white; font-size:16px;">Ladies Only</regular><i class="fas fa-venus" style="margin-left:3px;color:#8F1924; vertical-align:middle; font-size:20px;"> </i> </footer>  '; } else{      echo '<br> ';         }  ?>
